...
def special_flat_array(flat_img,amplis,sep_amplis=True,smooth_array=None,kernel='mean',window_size=40,mode='mirror',percentile=1.,normalize=True,norm='median',compensate_gain=True,return_norm_array=False,transition=2000):
...
class auxtel_flat:
    ...
    def smooth_flat(self,kernel='median',sep_amplis=True,window_size=40,mode='mirror',normalize=True,norm='median'):
    ...
    def special_flat(self,kernel='median',sep_amplis=True,window_size=40,mode='mirror',normalize=True,norm='median',compensate_gain=True):
        if hasattr(self,'norm_array')==False:
            print('Normalized array not found. Normalizing it now')
            return_norm_array = True
        else:
